...
class AddProductActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupActionBar()
        iv_add_update_product_add_product_activity.setOnClickListener(this)
        btn_submit_add_product_activity.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        ...
        if (v != null)
        {
            when (v.id) {
                ...
                R.id.iv_add_update_product_add_product_activity -> {
                ...
                R.id.btn_submit_add_product_activity -> {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            iv_add_update_product_add_product_activity.setImageDrawable(
            ...
            try {
                ...
                GlideLoader(this@AddProductActivity).loadProductPicture(mSelectedImageFileUri!!, iv_product_image_add_product_activity)
    ...
    private fun uploadProductDetails() {
        ...
        val username =
            this.getSharedPreferences(Constants.AMAZING_MART_PREFRENCES, Context.MODE_PRIVATE)
        ...
        val product = Product(
            ...
            username,
            et_product_title_add_product_activity.text.toString().trim { it <= ' ' },
            et_product_price_add_product_activity.text.toString().trim { it <= ' ' },
            et_product_description_add_product_activity.text.toString().trim { it <= ' ' },
            et_product_quantity_add_product_activity.text.toString().trim { it <= ' ' },
            mProductImageURL
        )
