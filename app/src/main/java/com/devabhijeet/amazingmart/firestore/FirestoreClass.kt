package com.devabhijeet.amazingmart.firestore
...
import com.devabhijeet.amazingmart.models.*
import com.devabhijeet.amazingmart.ui.activities.*
import com.devabhijeet.amazingmart.ui.fragments.DashboardFragment
import com.devabhijeet.amazingmart.ui.fragments.OrdersFragment
import com.devabhijeet.amazingmart.ui.fragments.ProductsFragment
import com.devabhijeet.amazingmart.ui.fragments.SoldProductsFragment
    ...
    fun getUserDetails(activity: Activity) {
        ...
        mFireStore.collection(Constants.USERS)
            ...
            .addOnSuccessListener { document ->
                ...
                val sharedPreferences = activity.getSharedPreferences(Constants.AMAZING_MART_PREFRENCES,Context.MODE_PRIVATE)
    ...
    fun uploadImageToCloudStorage(activity: Activity, imageFileURI: Uri?, imageType: String) {
        ...
        sRef.putFile(imageFileURI!!)
            .addOnSuccessListener { taskSnapshot ->
                ...
                Toast.makeText(activity.applicationContext,"product image uploaded successfully!",Toast.LENGTH_SHORT).show()
